...
const CONCEPT_IMAGES = [
  'https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=80&w=600&auto=format&fit=crop', // Meditação / Calma
  'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?q=80&w=600&auto=format&fit=crop', // Folha / Orgânico
  'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=600&auto=format&fit=crop', // Arquitetura / Clássico
  'https://images.unsplash.com/photo-1511556532299-8f662fc26c06?q=80&w=600&auto=format&fit=crop', // Minimalista / Escultura
  'https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=600&auto=format&fit=crop', // Tecnologia / Espaço
  'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=600&auto=format&fit=crop', // Mar / Natureza
  'https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?q=80&w=600&auto=format&fit=crop', // Floresta / Neblina
];
...
/**
 * Gera posts fictícios para o mês selecionado de forma que o calendário carregue preenchido
 */
export function generateMockPostsForMonth(year: number, month: number): Record<string, Post> {
  const posts: Record<string, Post> = {};
  
  // Vamos preencher de forma determinística 6 a 8 dias do mês com posts prontos
